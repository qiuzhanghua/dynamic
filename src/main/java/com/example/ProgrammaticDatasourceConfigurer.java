...
public class ProgrammaticDatasourceConfigurer implements TenantConnectionResolver {
    ...
    public ConnectionProvider resolve(String tenantId) {
        String connectionProviderName = "com.mysql.cj.jdbc.MysqlDataSource";
        String jdbcUrl = String.format("jdbc:%s://app:app@localhost/app", tenantId);
        switch (tenantId) {
            case "mysql":
                break;
            case "pgsql":
                jdbcUrl = String.format("jdbc:%s://app:app@localhost/app", tenantId);
                connectionProviderName = "org.postgresql.ds.PGSimpleDataSource";
                break;
            default:
                break;
        }
...
//            properties.put("password", "app");
            connectionFactoryConfiguration
                    .connectionProviderClassName(connectionProviderName)
//                    .principal(p)
